	...
	(function () {
	    ...
	    function fetchProfiles() {
	        ...
	        for (var i = 0; i < profilesArray.length; i++) {
	            $('#home-select-profile').append('<option value=' + profilesArray[i].prefs + '>' + profilesArray[i].profilename + '</option>');
	            $('#modify-select-profile').append('<option value=' + profilesArray[i].prefs + '>' + profilesArray[i].profilename + '</option>');
	            $('.delete-profiles-table tbody').append('<tr><td>' + profilesArray[i].profilename + '</td><td><button class="ms-Button btn-deleteprofile" title="Delete Profile">Delete</button></td></tr>');
	        };
	        refreshUI();
	    };
	    ...
	    function notifyMessage() {
	        $('.notification-message').fadeIn(500, function () {
	            $('.notification-message').fadeOut(5000);
	        });
	    };
	    ...
	    function applyProfilePrefrences(prefId) {
	        Word.run(function (context) {
	            ...
	            } else if (prefId == "pref3") {} else if (prefId == "pref4") {} else if (prefId == "pref5") {};
